...
const UserUpdate = () => {
  ...
  const savedBirthday = user.birthday;
  const formatedBirthday = new Date(savedBirthday).toLocaleString("en-US", {
    month: "short",
    day: "2-digit",
    year: "numeric",
  });
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Col lg={4} md={12} sm={12}>
                      <Form.Group controlId="formBasicEmail">
                        <Form.Label className="label mt-2">
                          Identity ID <span className="text-danger">*</span>
                        </Form.Label>
                        <Form.Control
                          type="text"
                          name="identityID"
                    ...
                    <Col lg={4} md={12} sm={12}>
                      <Form.Group controlId="formBasicAge">
                        <Form.Label className="label mt-2">Date of Birth</Form.Label>
                        <div>
                        <Button 
                          onClick={handleOpen}
                          className="form-control text-start bg-transparent text-black border"
                          >
                          {formatedBirthday}
                        </Button>
                        <Modal
