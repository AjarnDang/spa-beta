...
const UserAdd = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post("http://localhost:3333/useradd2", user);
          ...
          <div className="card border-0 shadow-sm p-4">
            <Form onSubmit={handleSubmit}>
              ...
              <Col lg={4} md={12} sm={12}>
                  ...
                  >
                    <Form.Label className="label mt-2">Identity ID <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="text"
                      name="identityID"
                      onChange={handleChange}
                      placeholder="11037xxxxxxxx"
                      className="w-100"
                      maxLength={13}
                      minLength={13}
                      required
                ...
                <Col lg={4} md={12} sm={12}>
                  ...
                  >
                    <Form.Label className="label mt-2">Date of Birth <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="date"
                      name="birthday"
                      onChange={handleChange}
