  ...
  const getQRCode = async (event) => {
    ...
    try {
      const res = await axios.get(
        "http://localhost:3333/useremail/" + email
      );
    ...
    <body className="signup-body">
      <div className="container">
        <div className="signup-form d-flex align-items-center justify-content-center">
          ...
          <h1 className='text-center text-white font-weight-bolder'>QR Code Generator</h1>
            <div className="card-body p-3">
              ...
              <div className="row mt-3">
                <div className="col-md-auto" id="qrCodeEl">
                  {qrcode && (
                    <>
                      <img src={qrcode} className="qrcode-image" style={{border:"1px solid #000", borderRadius:"5px"}} />
                      <br />
                      <a
                        id=""
            ...
            <a href="/register" class="text-decoration-none">Go back</a>
          </div>
          </div>
